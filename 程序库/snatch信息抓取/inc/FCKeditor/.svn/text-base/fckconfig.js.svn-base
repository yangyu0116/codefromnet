...
FCKConfig.ToolbarSets["Custom"] = [
	['Source','Preview','FitWindow', 'Templates', 'Cut','Copy','Paste','PasteText','PasteWord'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	['StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent','BGColor','About'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull', 'Link','Unlink','Anchor','Image','Flash','Table','Rule','Smiley','SpecialChar','FontName','FontSize','Bold','Italic','Underline','TextColor']
] ;
...
FCKConfig.FontNames	    = '宋体; 楷体_GB2312; 仿宋_GB2312; 黑体; 隶书;'
...
for (var i=0; i<96; i++)
{
	FCKConfig.SmileyImages[i] = i + '.gif';
}
FCKConfig.SmileyColumns = 12 ;
FCKConfig.SmileyWindowWidth		= 400 ;
FCKConfig.SmileyWindowHeight	= 360 ;
