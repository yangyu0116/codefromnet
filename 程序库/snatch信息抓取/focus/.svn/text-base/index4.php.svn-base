...
class Snatch
{
	...
	function getData($url)
	{
		...
		$sql = "INSERT INTO `house` (`Pid`,`Title`, `AreaID`,`CityID`,`DistID`,`CommID`,`Fitment`,`PriceType`,`Price`,`Room`,`Hall`,`Loo`,`Floor`,`FloorTotal`,`Direction`,`RealtyFee`,`Facility`,`Content`,`PostTime`,`Contact`,`Email`,`Tel`,`Mobile`,`ValidPeriod`,`IfPersonal`) ";
		$sql .= "VALUES ('4','".$Title."','1', '1', '".$DistID."','".$CommID."','".$Fitment."','1','".$Price."','".$Room."','".$Hall."','".$Loo."','".$Floor."','".$FloorTotal."','".$Direction."','".$RealtyFee."','".$Facility."','".$Content."','".$PostTime."','".$Contact."','".$Email."','".$Tel."', '".$Mobile."', '3', '1') ";
		//echo $sql."\r\n";
...
$url = 'http://esf.focus.cn/newesf/buy_frame.php';//（个人求购房源）必须设置
$start = 1;//起始页，必须设置
$end = 3;//结束页，必须设置
$MaxID = 10327610;//最大的ID，必须设置
$MinID = 10274864;//最小的ID，必须设置
//10211640-10096973,10137079-10064939,19041-18806,18803-18467,18465-18413,18412-18363,18357-18324,18323-17968
...
//$Snatch->getData('http://esf.focus.cn/esf/buy/18278.html');
