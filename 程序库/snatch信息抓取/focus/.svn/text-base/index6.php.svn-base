<?php
//房屋合租-找房（个人）
// $_SERVER['DOCUMENT_ROOT'].'/config.ini.php';
...
class Snatch
{
	...
	function getData($url)
	{
		...
		$sql .= "VALUES ('5','".$Title."','1', '1', '".$DistID."','".$CommID."','".$Fitment."','1','".$Price."','".$Room."','".$Hall."','".$Loo."','".$Floor."','".$FloorTotal."','".$Direction."','".$RealtyFee."','".$Facility."','".$Content."','".$PostTime."','".$Contact."','".$Email."','".$Tel."', '".$Mobile."', '3', '1', '0') ";
		//echo $sql."\r\n";
...
$url = 'http://esf.focus.cn/newesf/hire_frame.php';//（合租-有房）必须设置
$start = 1;//起始页，必须设置
$end = 2;//结束页，必须设置
$MaxID = 41752;//最大的ID，必须设置
$MinID = 0;//最小的ID，必须设置
...
//$Snatch->getData('http://esf.focus.cn/esf/hire/40384.html');
