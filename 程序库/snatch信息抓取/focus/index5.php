...
class Snatch
{
	...
	{  
		...
		$str = $this->postPage($url, '_pageIndex='.$page.'&q_role=person&q_if_cotenant=1');
		$pos0 = 0;
		while(1)
		{      
	...
	function getData($url)
	{
		...
		$sql = "INSERT INTO `house` (`Pid`,`Title`, `AreaID`,`CityID`,`DistID`,`CommID`,`Fitment`,`PriceType`,`Price`,`Room`,`Hall`,`Loo`,`Floor`,`FloorTotal`,`Direction`,`RealtyFee`,`Facility`,`Content`,`PostTime`,`Contact`,`Email`,`Tel`,`Mobile`,`ValidPeriod`,`IfPersonal`,`HasHouse`) ";
		$sql .= "VALUES ('5','".$Title."','1', '1', '".$DistID."','".$CommID."','".$Fitment."','1','".$Price."','".$Room."','".$Hall."','".$Loo."','".$Floor."','".$FloorTotal."','".$Direction."','".$RealtyFee."','".$Facility."','".$Content."','".$PostTime."','".$Contact."','".$Email."','".$Tel."', '".$Mobile."', '3', '1', '1') ";
		//echo $sql."\r\n";
...
$url = 'http://esf.focus.cn/newesf/lease_frame.php';//（合租-有房）必须设置
$start = 1;//起始页，必须设置
$end = 3;//结束页，必须设置
$MaxID = 10328308;//最大的ID，必须设置
$MinID = 10312907;//最小的ID，必须设置
//10211456-10166090,10137133-10116244,459268-451910,451846-442732,442732-441254,441253-438936,438932-438323,438210-433960
...
//$Snatch->getData('http://esf.focus.cn/esf/lease/436852.html');
