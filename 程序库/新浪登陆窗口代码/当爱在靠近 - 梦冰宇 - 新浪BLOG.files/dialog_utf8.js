 ...
 function dialog(){
	...
	var sBox = '\
		<table id="dialogBox" width="' + width + '" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #000;display:none;z-index:10;" alt="dialog_utf8">\
			...
			<tr>\
				<td height=0><iframe id="adframe" style="background:#FFFFFF;height:0px; width: 100%;" scrolling=no frameborder=0 src="/lm/iframe/20/20070406/16.html"></iframe></td>\
			</tr>\
		</table>\
...
this.shadow = function(){
  ...
  oIframe['style']['height'] = oDialog.offsetHeight;
	...
	this.open = function(_sUrl, _sMode){
		if(/login_show.php/.test(_sUrl)){
			//_sUrl=_sUrl.replace("login_show.php","login_show_lenovo.php");
			_sUrl=_sUrl+"&old=1";
		}
		this.show();
